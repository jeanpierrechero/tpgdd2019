/*
create view listaRolesDisponibles
as
select r.role_nombre,f.func_nombre,r.role_activo from mavema_pie.role r join mavema_pie.role_funcionalidad  r_f on r.role_codigo = r_f.role_codigo join mavema_pie.funcionalidad f on r_f.func_codigo = f.func_codigo where r.role_activo = 1  group by r.role_nombre,f.func_nombre,r.role_activo
*/
/*
create view listaRoles
as
select r.role_nombre,f.func_nombre,r.role_activo from mavema_pie.role r join mavema_pie.role_funcionalidad  r_f on r.role_codigo = r_f.role_codigo join mavema_pie.funcionalidad f on r_f.func_codigo = f.func_codigo  group by r.role_nombre,f.func_nombre,r.role_activo

*/

/*
create procedure dar_de_baja_role(@role decimal(6,0) )
as begin
...
*/
/*
create procedure eliminar_funcionalidad_rol(@rol int,@funcionalidad_nombre nvarchar(50))
as begin
...
create procedure dar_de_alta_role(@nombre_rol nvarchar(50))
as begin
...
create procedure asignar_funcionalidad_rol(@rol decimal(6,0),@funcionalidad_nombre nvarchar(50))
as begin
declare @funcionalidad_codigo decimal(6,0) 
set @funcionalidad_codigo = (select func_codigo from mavema_pie.funcionalidad where func_nombre = @funcionalidad_nombre )
...
/*ABM recorridos */
/*
create procedure alta_recorrido(@tramo decimal(18,2))
as begin
...
values (@cantidadRegistros,@tramo);

end
*/
/*
create procedure agregar_tramo_a_recorrido(@recorrido decimal(18,0),@nuevo_tramo decimal(18,2))
as begin
insert into mavema_pie.tramo_recorrido(reco_codigo,tram_codigo)
...
*/
/*
create procedure eliminar_tramo_a_recorrido(@recorrido decimal(18,0),@tramo decimal(18,2))
as begin
...
*/
/*
create procedure baja_recorrido(@recorrido decimal(18,0))
as begin
...
*/
/*
create view recorridos_disonibles 
as
select r.reco_codigo CODIGO_RECORRIDO,(select puer_nombre from mavema_pie.puerto where puer_id = t.tram_puerto_desde)PUERTO_ORIGEN,(select puer_nombre from mavema_pie.puerto where puer_id = t.tram_puerto_hasta)PUERTO_DESTINO,t.tram_precio_base PRECIO_BASE,t.reco_duracion DURACION from mavema_pie.recorrido r join mavema_pie.tramo_recorrido tr on r.reco_codigo = tr.reco_codigo join mavema_pie.tramo t on tr.tram_codigo = t.tram_codigo  where r.reco_activo != 0 group by r.reco_codigo,t.tram_puerto_desde,t.tram_puerto_hasta,t.tram_precio_base,t.reco_duracion
*/
/*

create view lista_recorridos
as
select r.reco_codigo CODIGO_RECORRIDO,(select puer_nombre from mavema_pie.puerto where puer_codigo = t.tram_puerto_desde)PUERTO_ORIGEN,(select puer_nombre from mavema_pie.puerto where puer_codigo = t.tram_puerto_hasta)PUERTO_DESTINO,t.tram_precio_base PRECIO_BASE,r.reco_activo ESTADO from mavema_pie.recorrido r join mavema_pie.tramo_recorrido tr on r.reco_codigo = tr.reco_codigo join mavema_pie.tramo t on tr.tram_codigo = t.tram_codigo group by r.reco_codigo,t.tram_puerto_desde,t.tram_puerto_hasta,t.tram_precio_base,r.reco_activo

*/

/*
create procedure modificar_tramo_origen(@tram_codigo decimal(18,2),@nuevo_puerto decimal(18,0) )
as begin
...
*/
/*
create procedure modificar_tramo_destino(@tram_codigo decimal(18,2),@nuevo_puerto decimal(18,0) )
as begin
...
*/
/*
create procedure alta_crucero(@id nvarchar(50),@modelo nvarchar(50),@fabricante_nombre nvarchar(255),@fecha_alta datetime)
as begin
...
*/
/*
create procedure baja_temporal_crucero(@id_crucero nvarchar(50),@fecha_inicio datetime,@fecha_estimada_fin datetime, @comentario nvarchar(255))
as begin
